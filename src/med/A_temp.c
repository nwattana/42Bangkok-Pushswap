...
/*   Updated: 2022/09/27 18:27:01 by nwattana         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	throw_b_rev(int ind, t_ms *ms, t_prog *prog, int need_rb)
{
	// use rrx instead of rx when first data lower than half size
	t_ch	ch;
	int		stop;
